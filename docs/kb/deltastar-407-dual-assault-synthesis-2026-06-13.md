...
| **Hasse–Davenport phases** | HD leaves Θ(f)=f/4 free phase DOF; homogeneous space contains a vector recohering S_b to max f−1. NECESSARY but PROVABLY INSUFFICIENT. Reduces to effective Katz at fixed q. |
