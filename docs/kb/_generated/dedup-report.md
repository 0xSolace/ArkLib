...
- `ArkLib` — 284 files, 5375 declarations
...
- `def Binius.BinaryBasefold.disagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1499](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1499) — Disagreement set Δ : The set of points where two functions disagree. For functions f^(i+ϑ) and g^(i+
