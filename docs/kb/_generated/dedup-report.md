...
- `def Binius.BinaryBasefold.disagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1479](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1479) — Disagreement set Δ : The set of points where two functions disagree. For functions f^(i+ϑ) and g^(i+
