...
- `ArkLib` — 2204 files, 28297 declarations
...
- `theorem Binius.BinaryBasefold.CoreInteraction.UDRClose_of_fin_eq` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean:735](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps/FinalSumcheck.lean#L735) — Transport `UDRClose` across an index equality and a heterogeneous function equality.
...
- `def Polynomial.Bivariate.hasseDerivX` [ArkLib/Data/CodingTheory/ProximityGap/1BruteForce.lean:54](../../../ArkLib/Data/CodingTheory/ProximityGap/1BruteForce.lean#L54) — `Δ_X^{k}`: the `k`-th Hasse derivative in the inner variable `X`, applied coefficient-wise: each `Y`
...
- `def Polynomial.Bivariate.hasseDerivY` [ArkLib/Data/CodingTheory/ProximityGap/1BruteForce.lean:49](../../../ArkLib/Data/CodingTheory/ProximityGap/1BruteForce.lean#L49) — `Δ_Y^{k}`: the `k`-th Hasse derivative in the outer variable `Y`, i.e. the ordinary mathlib `Polynom
