...
- `ArkLib` — 285 files, 5379 declarations
...
- `def Binius.BinaryBasefold.disagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1510](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1510) — Disagreement set Δ : The set of points where two functions disagree. For functions f^(i+ϑ) and g^(i+
