...
- `ArkLib` — 282 files, 5335 declarations
...
- `def Binius.BinaryBasefold.disagreementSet` [ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean:1373](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Prelude.lean#L1373) — Disagreement set Δ : The set of points where two functions disagree. For functions f^(i+ϑ) and g^(i+
