...
`Composition/Sequential/Append.lean` and the Fiat-Shamir run equalities. The current tree no longer
contains stale commented `placeholder` theorem bodies for these obligations.
