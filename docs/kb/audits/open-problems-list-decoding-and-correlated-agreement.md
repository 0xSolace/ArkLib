...
| `T4.8` | AHIV17 general-code unique-decoding | wrapper present; specialization open | [`ProximityGap/AHIV22.lean`](../../../ArkLib/Data/CodingTheory/ProximityGap/AHIV22.lean) (sorry-free as of `05a010e3`), [ProximityGap/Errors.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/Errors.lean) | `ProximityToRS.ahiv17_epsCA_bound` | The ABF26-facing `epsCA` wrapper is now present. Remaining #80 work is the source-level specialization from the current AHIV22 row-span probability theorem to the affine-line correlated-agreement predicate consumed by the wrapper. |
...
| `BCGM25` (extends T4.13/T4.14) | Polynomial-generator MCA | stated (shadow Prop; reconciliation open) | [CapacityBounds.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/CapacityBounds.lean), [ProximityGenerators.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/ProximityGenerators.lean), [MCAGenerator.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/MCAGenerator.lean) | `CodingTheory.subspaceDesign_epsCA_curves_polynomial_generators_bcgm25`, `CoreDefinitions.IsMCAGenerator` | BCGM25/BSGM25 (footnote 2 of ABF26 intro). The generator framework (`Generator`/`IsMCAGenerator`/`IsMCA`) is now in-tree, while the CapacityBounds entry remains an ε-error survey shadow using `epsCA_curves … k`. Reconcile or remove the shadow in favour of the generator-native API; tracked by #76. |
...
| `T4.16` | CA lower bound near capacity | stated (external Prop; split issue) | [CapacityBounds.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/CapacityBounds.lean) | `CodingTheory.rs_epsCA_lower_capacity_bchks25_kk25` | Prop-valued BCHKS25+KK25 statement. `Θ(1/log n)` slack is existentially packaged; the near-capacity witness construction is tracked by #81. |
| `T4.17` | Complete CA breakdown | stated (external Prop; split issue) | [CapacityBounds.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/CapacityBounds.lean) | `CodingTheory.rs_epsCA_breakdown_cs25` | Prop-valued CS25 Cor 1 statement using `qEntropy`; the `≤ 1` half is routine. The hard qEntropy/RS-ball-count lower witness is tracked by #82. |
| `T4.18` | CA jump at Johnson bound | stated (external Prop; split issue) | [CapacityBounds.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/CapacityBounds.lean) | `CodingTheory.rs_epsCA_johnson_jump_bchks25` | Prop-valued BCHKS25 Cor 1.7 statement. Johnson radius `J(δ) := 1 - √(1-δ)` is inlined; the witness-family construction is tracked by #83. |
| `L4.19` | CA bounded below by sampling probability | stated (external Prop; split issue) | [CapacityBounds.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/CapacityBounds.lean), related DG25 residual work in [DG25/MainResults.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/DG25/MainResults.lean) | `CodingTheory.linear_epsCA_ge_sampling_dg25` | Prop-valued DG25 Thm 2.5 statement. The DG25 files prove a different proximity-gap branch; the covering-radius sampling lower bound is tracked separately by #77. |
...
| `C4.5` | §4.5 MCA conjecture (`conj:mca-conjecture`): `ε_mca(C,δ) ≤ (1/\|F\|)·\|L\|^{c₁}/(ρ^{c₂}·η^{c₃})`, `η := 1−ρ−δ`, `δ < 1−ρ` | present (draft-source `Prop`) | `ProximityGap.GrandChallenges.mcaConjecture`, `ProximityGap.GrandChallenges.mcaConjectureBound`, `ProximityGap.GrandChallenges.nonempty_mcaLowerWitness_of_mcaConjecture` in [GrandChallenges.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/GrandChallenges.lean), lattice adapters in [GrandChallengesLattice.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/GrandChallengesLattice.lean) | new (Phase 1, 2026-06-03) | Stated as a `Prop` (∃ constants `c₁ c₂ c₃`, ∀ RS code & `δ<1−ρ`), term-by-term faithful to the source. Conjecture⇒`MCALowerWitness` and lattice-threshold links are proven and axiom-clean. **Source caveat (verified 2026-06-03): this conjecture sits inside an `\ignore{…}` block in the current `.tex` (≈line 2030) — a draft, not a statement rendered in the compiled paper.** API/status cleanup for this draft-source surface is tracked by #78. |
