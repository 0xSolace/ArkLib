...
| `T4.8` | AHIV17 general-code unique-decoding | UDR wrapper proved; tighter AHIV specialization open | [`ProximityGap/AHIV22.lean`](../../../ArkLib/Data/CodingTheory/ProximityGap/AHIV22.lean) (sorry-free as of `05a010e3`), [ProximityGap/Errors.lean](../../../ArkLib/Data/CodingTheory/ProximityGap/Errors.lean) | `ProximityToRS.ahiv17_epsCA_bound_uniqueDecodingRegime` | The ABF26-facing `epsCA` wrapper is present, and `ahiv17_epsCA_bound_uniqueDecodingRegime` now discharges the affine-line residual in the unique-decoding regime via `RS_correlatedAgreement_affineLines_uniqueDecodingRegime`, yielding the in-tree `errorBound δ deg α` bound. Remaining #80 work is the tighter AHIV17 row-span theorem to affine-line specialization, which should improve the bound to the AHIV `‖RS‖₀/|F|` form. |
