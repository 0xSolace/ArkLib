...
opaque gkl24_cubeRoot_mca_bound
...
opaque bgks20_etaMargin_ca_bound
    (C : ModuleCode ι F A) (δ_min η δ : ℝ≥0)
    (h_δ_min : (δ_min : ℝ) = (Code.minDist (C : Set (ι → A)) : ℝ) / Fintype.card ι)
    (hη : 0 < η) (hη_lt_δ_min : η < δ_min)
    (hδ : (δ : ℝ) ≤ 1 - ((1 - (δ_min : ℝ) + (η : ℝ)) ^ ((1 : ℝ) / 3))) :
...
opaque bchks25_rs_epsMCA_johnson_range
...
opaque bchks25_kk25_rs_epsCA_lower_capacity
...
opaque cs25_rs_epsCA_breakdown_lower
...
opaque bchks25_rs_epsCA_johnson_jump
...
opaque gg25_subspaceDesign_epsMCA
...
opaque gg25_frs_epsMCA_capacity
