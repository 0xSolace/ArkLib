...
cleared-base structured-invariant endpoint. -/
...
cleared-base structured-invariant endpoint using successor-order lift identities. -/
...
through the direct cleared-base structured-invariant endpoint. -/
