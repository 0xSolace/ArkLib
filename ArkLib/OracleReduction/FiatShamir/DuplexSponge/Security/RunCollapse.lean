...
/-!
  # Discharging the Duplex-Sponge Fiat-Shamir Run-Collapse Residual

  This file discharges the duplex-sponge Fiat-Shamir (DSFS) run-collapse residual
  `Reduction.duplexSpongeFiatShamir_runCollapseResidual` left open in
  `FiatShamir/DuplexSponge/Security/Completeness.lean`, and feeds it into the existing bridge
...
attribute [local instance] Reduction.dsfsProverOnly
