...
--     ∀ i : (pSpec₁.cast hn).MessageIdx, OracleInterface (Q placeholder) ((pSpec₁.cast hn).Message i) :=
...
--     T.cast h hIdx hSpec  = (dcast₃ h (by placeholder) placeholder T : pSpec₂.Transcript l) := rfl
