...
This file proves `Reduction.append_perfectCompleteness_empty_proof`, the genuine perfect-completeness
...
theorem append_perfectCompleteness_empty_proof
  ...
  · -- NeverFails
    ...
    simp only [Prover.append_run_empty _ _, Verifier.append_run,
