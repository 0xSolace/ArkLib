...
/-!
# Batched FRI soundness adapters from RS-curve probability routes

`QueryRoundProbability.lean` exposes the query-level Batched FRI subdomain Reed-Solomon
polynomial-curve route.  This companion module lifts that route to the full-domain Claim 8.3
surfaces without growing `QueryRoundSoundness.lean`, which is near the repository line cap.
-/

namespace Fri
section RSCurveProbabilitySoundnessAdapter
...
end RSCurveProbabilitySoundnessAdapter
end Fri
