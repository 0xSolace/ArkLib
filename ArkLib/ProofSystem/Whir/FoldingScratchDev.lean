...
`Fold.folding_preserves_listdecoding_base_mca`. This scratch file intentionally exports no
declarations, avoiding a duplicate-definition race with the production namespace.
-/
