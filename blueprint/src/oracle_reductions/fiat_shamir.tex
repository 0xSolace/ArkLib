...
\begin{remark}[Grant Closeout Status and Residual Frontier]
    ...
    the implication is trivially true over the deviant event. The CO25-faithful repaired
    event together with re-proofs of the M2 block over it is the active repair lane
    (issue~\#314).
    ...
    statement surface with an over-strong \(\eta^\star\) exponent and is superseded by the
    eager surface; it is kept only as a named historical interface.
