...
\input{oracle_reductions/fiat_shamir}
...
\input{proof_systems/fri}

\input{proof_systems/ring_switching}

\input{proof_systems/binius}

\input{proof_systems/spartan}

\input{proof_systems/stir}

\input{proof_systems/whir}
